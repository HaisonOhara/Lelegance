...
<head>
  ...
  <title>L'elegance Alterar Gerente</title>
          ...
          <div class="card-body">
            ...
            <form class="form-signin" method="post" action="../alterarFuncionario">
              ...
              <div class="form-label-group">
                <input type="text" id="inputNome" name="nome" value="${fun.nome}" class="form-control" placeholder="Nome" required autofocus>
                
              </div>
              <div class="form-label-group">
                <input type="text" id="inputEmail" name="email" value="${fun.email}" class="form-control" placeholder="Email" required autofocus>        
              </div>
