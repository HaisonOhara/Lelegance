            ...
            <div class="row">
                <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
                    <div class="card card-signin my-5">
                        <div class="card-body">
                            <h5 class="card-title text-center">Editar Estilo</h5>
                            <form class="form-signin" method="post" action="../alterarEstilo?idEstilo=${idEstilo}" enctype="multipart/form-data">
                                ...
                                <div class="form-label-group">
                                    <input type="numeric" name="valor" id="inputValor" class="form-control" value="${estilo.valor}" placeholder="Valor da Box" required>
                                </div>
