...
<head>
  ...
  <title>L'elegance Funcionário</title>
...
<nav class="navbar navbar-dropdown navbar-fixed-top navbar-expand-lg">
    <div class="row">
      <div class="container">
        ...
        <ul class="nav-menu list-unstyled">
          <li><a href="index.jsp" class="smoothScroll">Novo Estilo</a></li>
  ...
  <div class="container">
    ...
    <td>Classico</td>
    <td>Lorem Ibson</td>
    <td>Feminino/Masculino/Neutro</td>
	<th>100,00</th>
    <th><input type="submit" name="alterar" value="Alterar"/></th>
    </tr>
    </tbody> 
     <tbody>    
    <tr>    
